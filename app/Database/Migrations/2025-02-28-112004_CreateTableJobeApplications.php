...
class CreateJobApplicationsTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'testimonial1_name' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'testimonial1_father' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'testimonial1_address' => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'testimonial1_phone' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'testimonial2_name' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'testimonial2_father' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'testimonial2_address' => ['type' => 'VARCHAR', 'constraint' => 255, 'null' => true],
            'testimonial2_phone' => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            'gender' => [
                'type'       => 'ENUM',
