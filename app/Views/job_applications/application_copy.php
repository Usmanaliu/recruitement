    ...
    <div id="main_app" class="form">
        ...
        <table id="application_tbl" class=" form-table w-100 text-end border">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="field mx-3"><?= esc($application['dob']) ?></span> <span class="mx-1">تاریخ پیدائش بمطابق میٹرک سند</span></td>
                    <td><span class="field mx-3"><?= esc($application['cast']) ?></span> <span class="mx-1">ذات</span></td>
                    <td><span class="field mx-3"><?= esc($application['religion']) ?></span> <span class="mx-1">مذہب</span></td>
                    <td><span>.3</span></td>
                </tr>
                <tr id="row_4">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td><span> قومی شناختی کارڈ نمبر </span></td>
                    <td><span> .9 </span></td>
                </tr>
            </tbody>
        </table>
        <table class="w-100 tbl2 boarder text_direction">
            ...
            <tbody>
                ...
                <tr class="border-bottom-0 border-top-0">
                    ...
                    <td><span>موبائل نمبر</span><span class="field mx-3"><?= $application['testimonial1_phone'] ?></span></td>
                </tr>
                <tr class="border-bottom-0 border-top-0">
                    <td>&nbsp;</td>
                ...
                <div class="col-9">
                    <table class="text_direction slipTbl ">
                        <tbody>
                            <tr>
                                <td>فارم نمبر</td>
                                <td> <span class="field mx-3 fw-bold  text-primary"> <?= esc($application['application_id'])   ?> </span></td>
                                <td>برائے آسامی</td>
                            ...
                            <tr>
                                <td>نام</td>
                                <td> <span class="field mx-3 fw-bold text-primary"> <?= esc($application['cand_name_urdu']) ?> </span></td>
                                <td>ولدیت</td>
